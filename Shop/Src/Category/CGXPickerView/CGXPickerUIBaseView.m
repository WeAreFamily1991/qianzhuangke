...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.frame = CGRectMake(WScale(15), WScale(20), WScale(30), WScale(20));
...
//            _leftBtn.hidden =YES;
//        }
        _leftBtn.titleLabel.font = DR_FONT(14);
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.frame = CGRectMake(SCREEN_WIDTH - WScale(45), WScale(20), WScale(30), WScale(20));
//        _rightBtn.backgroundColor = self.manager.rightBtnBGColor;;
        ...
        _rightBtn.titleLabel.font = DR_FONT(14);
