...
- (void)setView{
    ...
    [_reduceBtn setImage:[UIImage imageNamed:@"num_subtract_black"] forState:UIControlStateNormal];
    ...
    [_addBtn setImage:[UIImage imageNamed:@"num_add_black"] forState:UIControlStateNormal];
