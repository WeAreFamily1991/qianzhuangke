...
//            middleLine.backgroundColor=BACKGROUNDCOLOR;
...
- (void)showTableView:(UIButton *)btn {
    ...
    if (_bgView == nil) {
        _bgView = [[UIView alloc] initWithFrame:CGRectMake(0, DRTopHeight+40, self.width, QZ_SCREEN_HEIGHT - DRTopHeight+40)];
    ...
    for (NSInteger i = 0; i<self.filterButtons.count; i++) {
        ...
        if (btn == filterButton) {
            ...
            self.filterTableView.frame = CGRectMake(0, DRTopHeight+40, self.width, 0);
