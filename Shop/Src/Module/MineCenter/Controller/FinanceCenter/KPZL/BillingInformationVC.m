...
-(void)addsegentView
{
    ...
    ///线
    UILabel *linetLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,1,SCREEN_WIDTH,0.8)];
...
//    [self.titleView addSubview:lineLabel];
    ...
    self.pageContentView = [[FSPageContentView alloc]initWithFrame:CGRectMake(0,WScale(50), SCREEN_WIDTH,SCREEN_HEIGHT-WScale(50)-DRTopHeight) childVCs:childVCs parentVC:self delegate:self];
