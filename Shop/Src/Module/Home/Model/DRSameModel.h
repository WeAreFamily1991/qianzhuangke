...
@property (nonatomic , assign) double              level2_price;
...
@property (nonatomic , assign) double              level_price;
...
@property (nonatomic , assign) double              stMoq;
...
@property (nonatomic , assign) double              zfMoq;
...
@property (nonatomic , assign) double              allowbuycount;
...
@property (nonatomic , assign) double              discountvalue;
...
@property (nonatomic , assign) double              saleUnitConversion;
