...
@interface DRCuXiaoModel : DRBaseModel
@property (nonatomic , copy) NSString              * isShow;
@property (nonatomic , copy) NSString              * cuxiaoID;
...
@property (nonatomic , copy) NSString              * stCategoryVOList;
