...
@interface DRShopCatoryVC ()<GHCountFieldDelegate,LDYSelectivityAlertViewDelegate,GHDropMenuDelegate>
{
    int pageCount;
...
-(void)getMsgList
{
    if (!_sendDataDictionary) {
       ...
       // level2Id   分类左边ID
        ...
        //districtid  区域ID
        //onlyqty  是否显示有货 0或者1
        if ([self.queryTypeStr isEqualToString:@"cloud"]) {
            ...
            if (IDArr.count>=3) {
                ...
                _sendDataDictionary = [NSMutableDictionary dictionaryWithObjects:@[@"",IDArr[0],IDArr[1],_czID?:@"",@"1",IDArr[2],@"",@"",@"",@"",[DRUserInfoModel sharedManager].locationCode?:@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"0"] forKeys:@[@"keyword",@"level1Id",@"level2Id",@"czid",@"subType",@"categoryId",@"condition",@"serviceType",@"sellerType",@"containzy",@"districtid",@"orderBy",@"onlyqty",@"standardId",@"levelid",@"surfaceId",@"lengthId",@"materialId",@"toothdistanceid",@"toothformid",@"brandid",@"czid",@"diameterid",@"voucherType"]];
            }
            if ([self.searchTypeStr isEqualToString:@"search"]) {
        ...
        else
        {
            ...
            if (IDArr.count>=3) {
                [GoodsShareModel sharedManager].level1Id =IDArr[0];
                [GoodsShareModel sharedManager].level2Id =IDArr[1];
                _sendDataDictionary = [NSMutableDictionary dictionaryWithObjects:@[self.queryTypeStr,@"",IDArr[0],IDArr[1],@"1",IDArr[2],@"",@"",@"",@"",[DRUserInfoModel sharedManager].locationCode?:@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",_czID?:@"",@"",@""] forKeys:@[@"queryType",@"keyword",@"level1Id",@"level2Id",@"subType",@"categoryId",@"condition",@"serviceType",@"sellerType",@"containzy",@"districtid",@"orderBy",@"onlyqty",@"standardId",@"levelId",@"surfaceId",@"lengthId",@"materialId",@"toothdistanceid",@"toothformid",@"brandid",@"czid",@"diameterid",@"voucherType"]];
            }
            if ([self.searchTypeStr isEqualToString:@"search"]) {
                _sendDataDictionary = [NSMutableDictionary dictionaryWithObjects:@[self.queryTypeStr?:@"",@"",@"",@"",@"",@"1",@"",@"",@"",@"",@"",[DRUserInfoModel sharedManager].locationCode?:@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"0"] forKeys:@[@"queryType",@"keyword",@"level1Id",@"level2Id",@"cz",@"subType",@"categoryId",@"condition",@"serviceType",@"sellerType",@"containzy",@"districtid",@"orderBy",@"onlyqty",@"standardId",@"levelid",@"surfaceId",@"lengthId",@"materialId",@"toothdistanceid",@"toothformid",@"brandid",@"czid",@"diameterid",@"voucherType"]];
            }
...
-(void)loadDataSource:(NSMutableDictionary*)dictionary withpagecount:(NSString *)page
{
    ...
    [dictionary setObject:@"false" forKey:@"saleSort"];
    if ([self.isAirCloudYes boolValue]==YES) {
        [dictionary setObject:self.sellidStr?:@"local" forKey:@"storeid"];
    
    }else
    {
        [dictionary setObject:self.sellidStr?:@"base" forKey:@"storeid"];
    }
    [dictionary setObject:@"" forKey:@"jbcz"];
    ...
    [dictionary setObject:self.keyWordStr?:@"" forKey:@"keyword"];
     if ([self.sellidStr isEqualToString:[DRUserInfoModel sharedManager].zyStoreId])
     {
...
-(void)getItemWithArray:(NSArray*)array
{
    ...
    [mudic setObject:[DRUserInfoModel sharedManager].locationCode?:@"" forKey:@"district"];
...
-(void)addTypeWithSource
{
    ...
    if ([self.queryTypeStr isEqualToString:@"cloud"])
    {
        urlStr =@"mainPage/getCloudBannerRelationCondition";
        NSArray *IDArr =[_classListStr componentsSeparatedByString:@","];
           NSLog(@"");
           if (IDArr.count>=3) {
               [GoodsShareModel sharedManager].level1Id =IDArr[0];
               [GoodsShareModel sharedManager].level2Id =IDArr[1];
               NSString *ckStr=self.sellidStr ;
               if ([self.isAirCloudYes integerValue]==1) {
                   if ([self.sellidStr isEqualToString:@"local"]||self.sellidStr.length==0) {
                       ckStr=@"";
                   }
               }
               else if ([self.isAirCloudYes integerValue]==0)
               {
                   if ([self.sellidStr isEqualToString:@"base"]||self.sellidStr.length==0) {
                       ckStr=@"";
                   }
               }
               if (!_typeDic) {
                   _typeDic =[NSMutableDictionary dictionaryWithObjects:@[[self.isAirCloudYes boolValue]?@"local":@"base",_czID?:@"",ckStr,@"init",IDArr[0]?:@"",IDArr[1]?:@"",@"1",IDArr[2]?:@"",[DRUserInfoModel sharedManager].locationCode?:@"",[DRUserInfoModel sharedManager].locationCode?:@""] forKeys:@[@"localStoreId",@"cz",@"ck",@"type",@"level1Id",@"level2Id",@"subType",@"categoryId",@"district",@"districtId"]];
               }
               
           }
        if ([self.searchTypeStr isEqualToString:@"search"])
        {
            urlStr =@"mainPage/getCloudBannerSearchRelationCondition";
                [_typeDic setValue:self.keyWordStr forKey:@"keyword"];
        }
        if ([self.sellidStr isEqualToString:[DRUserInfoModel sharedManager].zyStoreId]) {
            urlStr =@"mainPage/getCloudRelationCondition";//三铁云仓
            NSArray *IDArr =[_classListStr componentsSeparatedByString:@","];
            NSLog(@"");
            if (IDArr.count>=3) {
                [GoodsShareModel sharedManager].level1Id =IDArr[0];
                [GoodsShareModel sharedManager].level2Id =IDArr[1];
                _typeDic =[NSMutableDictionary dictionaryWithObjects:@[_czID?:@"",@"",@"init",IDArr[0]?:@"",IDArr[1]?:@"",@"1",IDArr[2]?:@"",[DRUserInfoModel sharedManager].locationCode?:@"",[DRUserInfoModel sharedManager].locationCode?:@""] forKeys:@[@"cz",@"ck",@"type",@"level1Id",@"level2Id",@"subType",@"categoryId",@"district",@"districtId"]];
            }
            
            if ([self.searchTypeStr isEqualToString:@"search"])
            {
                urlStr =@"mainPage/getCloudSearchRelationCondition";
                [_typeDic setValue:self.keyWordStr forKey:@"keyword"];
            }
        }
    ...
    else
    {
        ...
        {
            urlStr =@"mainPage/getSellerRelationCondition";//第三方卖家
            NSArray *IDArr =[_classListStr componentsSeparatedByString:@","];
            NSLog(@"");
            if (IDArr.count>=3) {
                [GoodsShareModel sharedManager].level1Id =IDArr[0];
                ...
                if (!_typeDic) {
                    _typeDic =[NSMutableDictionary dictionaryWithObjects:@[self.sellidStr?:@"",_czID?:@"",@"",@"init",IDArr[0]?:@"",IDArr[1]?:@"",@"1",IDArr[2]?:@"",[DRUserInfoModel sharedManager].locationCode?:@"",[DRUserInfoModel sharedManager].locationCode?:@""] forKeys:@[@"sellerId",@"cz",@"czName",@"type",@"level1Id",@"level2Id",@"subType",@"categoryId",@"district",@"districtId"]];
                }
            }
            if ([self.searchTypeStr isEqualToString:@"search"])
            {
                urlStr =@"mainPage/getSellerSearchRelationCondition";
                [_typeDic setValue:self.keyWordStr forKey:@"keyword"];
            }
        }
    }
