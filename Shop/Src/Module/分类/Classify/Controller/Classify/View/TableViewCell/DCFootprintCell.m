...
- (void)setFootprintItem:(ItemList *)footprintItem
{
    _footprintItem = footprintItem;
    [_goodImageView sd_setImageWithURL:[NSURL URLWithString:footprintItem.img]];
    _priceLabel.text = [NSString stringWithFormat:@"¥ %.2ld",(long)footprintItem.userPrice];
    _goodName.text = footprintItem.itemName;
}
