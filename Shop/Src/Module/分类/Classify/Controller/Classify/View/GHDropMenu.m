...
- (void)layoutSubviews {
    ...
    self.collectionView.frame = CGRectMake(0, DRTopHeight, kGHScreenWidth, self.menuHeight);
...
- (void)clickButton: (UIButton *)button {
    ...
    if (button.tag == GHDropMenuButtonTypeSure) {
        ...
        if (self.selectedBlock) {
            self.selectedBlock(dropMenuTitleModel,dataArray.copy);
        }
...
- (UIButton *)sure {
    if (_sure == nil) {
        ...
        _sure.backgroundColor = REDCOLOR;
