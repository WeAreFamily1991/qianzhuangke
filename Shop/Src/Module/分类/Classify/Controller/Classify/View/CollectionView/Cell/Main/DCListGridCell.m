...
- (void)setYouSelectItem:(ItemList *)youSelectItem
{
    _youSelectItem = youSelectItem;
    [_gridImageView sd_setImageWithURL:[NSURL URLWithString:youSelectItem.img]];
    _priceLabel.text = [NSString stringWithFormat:@"¥ %.2ld",(long)youSelectItem.userPrice];
    _gridLabel.text = youSelectItem.itemName;
    //首行缩进
    [DCSpeedy dc_setUpLabel:_gridLabel Content:youSelectItem.itemName IndentationFortheFirstLineWith:_gridLabel.font.pointSize * 2.5];
}
