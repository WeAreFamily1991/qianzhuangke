...
- (void)setUpNavBarView
{
    ...
    [backBT setImage:[UIImage imageNamed:@"ico_back_white"] forState:UIControlStateNormal];
    [backBT setImage:[UIImage imageNamed:@"ico_back_white"] forState:UIControlStateHighlighted];
...
- (void)didScorll:(UIScrollView *)scorllView
{
    ...
    if (_alpha >= 0.5) {
        ...
        [_backBT   setImage:IMAGENAMED(@"ico_back_white") forState:UIControlStateNormal];
